...
4. **Z-score normalization**: $Z = (RI_{real} - \mu_{null}) / \sigma_{null}$, with p-values derived via normal approximation: $p = 2\Phi(-|Z|)$.
...
res <- ppi_knock(ppi_scored, targets = "IL6", n_perm = 100)
res$Summary
